 ...
 */
require_once XOOPS_ROOT_PATH.'/modules/club/class/pear/Image/Canvas/WithMap.php';

/**
 * Include file Image/Canvas/Color.php
 */
require_once XOOPS_ROOT_PATH.'/modules/club/class/pear/Image/Canvas/Color.php';
...
class Image_Canvas_GD extends Image_Canvas_WithMap
{
    ...
    {
        include_once XOOPS_ROOT_PATH.'/modules/club/class/pear/Image/Canvas/Color.php';
    ...
    {
        include_once XOOPS_ROOT_PATH.'/modules/club/class/pear/Image/Canvas/Tool.php';
