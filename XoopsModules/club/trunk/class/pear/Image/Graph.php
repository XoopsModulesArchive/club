 ...
 */
require_once XOOPS_ROOT_PATH.'/modules/club/class/pear/Image/Graph/Element.php';

/**
 * Include file Image/Graph/Constants.php
 */
require_once XOOPS_ROOT_PATH.'/modules/club/class/pear/Image/Graph/Constants.php';
...
class Image_Graph extends Image_Graph_Element
{
    ...
    function Image_Graph($params, $height = false, $createTransparent = false)
    {
        ...
        if ($this->_canvas == null) {
            include_once XOOPS_ROOT_PATH.'/modules/club/class/pear/Image/Canvas.php';
            $this->_canvas =&
    ...
    function &factory($class, $params = null)
    {
        ...
        include_once XOOPS_ROOT_PATH.'/modules/club/class/pear/'.str_replace('_', '/', $class) . '.php';
    ...
    function &layoutFactory($layout, &$part1, &$part2, $percentage = 50)
    {
        ...
        include_once XOOPS_ROOT_PATH."/modules/club/class/pear/Image/Graph/Layout/$layout.php";
